...
namespace XCaseServiceClient
{
                    ...
                    string interfaceString = @"namespace XCaseServiceClient
    {
        ...
        public interface IUserProxy
        {
            public void logout();
                    ...
                    string proxyString = @"namespace XCaseServiceClient {
    /* This file was generated by XCase.REST.SwaggerCSharpProxyGenerator */
    ...
    /// </summary>
        public class UserProxy : KlearNowProxy, IUserProxy
        {
            ...
            private static readonly new ILog Log = log4net.LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);
            ...
            public void logout()
            {
                ...
                using (HttpClient apiClient = BuildHttpClient())
                {
                    ...
                    string[] sourceStringArray = new string[] { interfaceString, proxyString };
                    ...
                    Log.DebugFormat("set m_ServicesComboBox datasource");
                    ...
                    Log.DebugFormat("selected item is {0}", m_ServicesComboBox.SelectedItem);
