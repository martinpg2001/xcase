...
java -Djsse.enableSNIExtension=false -classpath %CLASSPATH% com.xcase.common.CommonApplication -F file=@./docs/TestFile.txt -X POST http://localhost:8080/examples/jsp/upload/Action_file_upload.jsp