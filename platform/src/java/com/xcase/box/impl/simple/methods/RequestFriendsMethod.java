...
public class RequestFriendsMethod extends BaseBoxMethod {
    ...
    public RequestFriendsResponse requestFriends(
            RequestFriendsRequest requestFriendsRequest) throws IOException, BoxException {
        RequestFriendsResponse baseBoxResponse = BoxResponseFactory.createRequestFriendsResponse();
        ...
        if (BoxConstant.CONFIG_API_REQUEST_FORMAT_REST.equals(apiRequestFormat)) {
            ...
            StringBuffer urlBuff = super.getRestUrl(BoxConstant.ACTION_NAME_REQUEST_FRIENDS);
