...
public class PostTypesMethod extends BaseCDSRefDataMethod {
	...
	public PostTypesResponse postTypes(PostTypesRequest request) {
        LOGGER.debug("starting postTypes()");
        PostTypesResponse response = CDSRefDataResponseFactory.createPostTypesResponse();
        ...
        try {
            ...
            endPoint = endPoint.replace("{type}", typeHashMap.get(type));
