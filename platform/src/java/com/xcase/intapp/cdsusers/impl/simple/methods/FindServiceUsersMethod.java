...
public class FindServiceUsersMethod extends BaseCDSUsersMethod {
    ...
    public FindServiceUsersResponse findServiceUsers(FindServiceUsersRequest request) {
        LOGGER.debug("starting findServiceUsers()");
        FindServiceUsersResponse response = CDSUsersResponseFactory.createFindServiceUsersResponse();
