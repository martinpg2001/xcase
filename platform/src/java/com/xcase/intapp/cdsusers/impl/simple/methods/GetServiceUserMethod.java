...
public class GetServiceUserMethod extends BaseCDSUsersMethod {
    ...
    public GetServiceUserResponse getServiceUser(GetServiceUserRequest request) {
        LOGGER.debug("starting getServiceUser()");
        GetServiceUserResponse response = CDSUsersResponseFactory.createGetServiceUserResponse();
