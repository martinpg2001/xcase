...
public class CDSCMRequestFactory extends BaseCDSCMFactory {
	...
	public static CreateMattersUsingPatchRequest createCreateMattersUsingPatchRequest() {
        Object obj = newInstanceOf("cdscm.config.requestfactory.CreateMattersUsingPatchRequest");
        return (CreateMattersUsingPatchRequest) obj;
	}

	public static CreateMattersUsingPatchRequest createCreateMattersUsingPatchRequest(String accessToken) {
		CreateMattersUsingPatchRequest request = createCreateMattersUsingPatchRequest();
        request.setAccessToken(accessToken);
        return request;
	}
	
    public static CreateClientsUsingPatchRequest createCreateClientsUsingPatchRequest() {
        Object obj = newInstanceOf("cdscm.config.requestfactory.CreateClientsUsingPatchRequest");
        return (CreateClientsUsingPatchRequest) obj;
    }

    public static CreateClientsUsingPatchRequest createCreateClientsUsingPatchRequest(String accessToken) {
        CreateClientsUsingPatchRequest request = createCreateClientsUsingPatchRequest();
        request.setAccessToken(accessToken);
        return request;
    }
