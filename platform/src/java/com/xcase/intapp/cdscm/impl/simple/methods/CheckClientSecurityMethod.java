...
public class CheckClientSecurityMethod extends BaseCDSCMMethod {
    /**
     * log4j object.
     */
    protected static final Logger LOGGER = LogManager.getLogger(MethodHandles.lookup().lookupClass());
    
	public CheckClientSecurityResponse checkClientSecurity(CheckClientSecurityRequest request) {
        LOGGER.debug("starting checkClientSecurity()");
        CheckClientSecurityResponse response = CDSCMResponseFactory.createCheckClientSecurityResponse();
        ...
        try {
            ...
            String[] idsArray = request.getIdsArray();
