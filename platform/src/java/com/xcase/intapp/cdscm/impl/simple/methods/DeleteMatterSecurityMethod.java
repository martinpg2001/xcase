...
public class DeleteMatterSecurityMethod extends BaseCDSCMMethod {
    /**
     * log4j object.
     */
    protected static final Logger LOGGER = LogManager.getLogger(MethodHandles.lookup().lookupClass());
    
	public DeleteMatterSecurityResponse deleteMatterSecurity(DeleteMatterSecurityRequest request) {
        LOGGER.debug("starting deleteMatter()");
        DeleteMatterSecurityResponse response = CDSCMResponseFactory.createDeleteMatterSecurityResponse();
