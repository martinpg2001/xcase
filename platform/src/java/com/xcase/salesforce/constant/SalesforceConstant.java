...
public class SalesforceConstant {
    ...
    public static final String LOCAL_OAUTH2_PASSWORD = "salesforce.config.api.oauth2_password";
    public static final String LOCAL_OAUTH2_REDIRECT_URL = "salesforce.config.api.oauth2_redirect_url";
    ...
    public static final String LOCAL_OAUTH2_USERNAME = "salesforce.config.api.oauth2_username";
