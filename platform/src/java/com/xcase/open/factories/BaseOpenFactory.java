...
public class BaseOpenFactory {
     ...
     * Open config.
     */
    private static final Properties CONFIG = OpenConfigurationManager.getConfigurationManager().getConfig();
...
//        LOGGER.debug("className is " + className);
        if (className == null || className.equals("")) {
            className = "com.xcase.open.impl.simple.transputs" + interfaceKey.substring(interfaceKey.lastIndexOf('.', interfaceKey.length())) + "Impl";
//            LOGGER.debug("className is " + className);
        }
