 ...
 *
 */
public class SharepointAbstractFileImpl implements SharepointAbstractFile {
    ...
    /**
     * tags, SharepointTag object list.
     */
    private List tags;
    ...
    public String toString() {
        ...
        for (int i = 0; i < tags.size(); i++) {
            SharepointTag tag = (SharepointTag) tags.get(i);
            sb.append("tag[" + i + "]=" + tag + "  ");
        }
        return sb.toString();
    }

    // public SharepointFile toSharepointFile() {
    // SharepointFile SharepointFile = BoxObjectFactory.createSharepointFile();
    // SharepointFile.setCreated(created);
    // SharepointFile.setDescription(null);
    // SharepointFile.setFileId(id);
    // SharepointFile.setFileName(name);
    // SharepointFile.set
    //
