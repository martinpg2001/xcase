...
public class BaseSlackFactory {
     ...
     * integrate config.
     */
    private static final Properties CONFIG = SlackConfigurationManager.getConfigurationManager().getConfig();
...
//        LOGGER.debug("starting newInstanceOf()");
        ...
        try {
            ...
            LOGGER.info("ClassNotFoundException exception creating new instance: " + cnfe.getMessage());
        } catch (InstantiationException ie) {
            LOGGER.info("InstantiationException exception creating new instance: " + ie.getMessage());
        } catch (IllegalAccessException iae) {
            LOGGER.info("IllegalAccessException exception creating new instance: " + iae.getMessage());
        } catch (InvocationTargetException ite) {
            LOGGER.info("InvocationTargetException exception creating new instance: " + ite.getMessage());
        } catch (NoSuchMethodException nsme) {
            LOGGER.info("NoSuchMethodException exception creating new instance: " + nsme.getMessage());
        }
