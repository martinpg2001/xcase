namespace XCaseGeneric
{
    ...
    /// <summary>
    /// This action class copies or moves a WebDAV item. The XML file should be of this form:
    /// <operation id="Copy a WebDAV item" class="XCaseGeneric.ActionWebDAVCopyMoveItem">
    ///     <webdav server="" username="" password="" />
    /// </operation>
    /// The ssl attribute is optional.
    /// </summary>
    public class ActionWebDAVCopyMoveItem : ActionAbstract
    {
        #region Logger Setup
        /// <summary>
        ...
        /// <summary>
        /// This method puts a WebDAV item. The XML file should be of this form:
        /// <operation id="Copy a WebDAV item" class="XCaseGeneric.ActionWebDAVCopyMoveItem">
        ///     <webdav server="" username="" password="" sourcepath="" />
        /// </operation>
        /// The ssl attribute is optional.
        /// </summary>
        ...
        public override OperationResult Execute(XmlDocument document)
        {
            ...
            try
            {
                OperationResult operationResult = new OperationResult("Success copying/moving WebDAV item");
            ...
            {
                string exceptionMessage = "Exception copying/moving WebDAV item " + e.Message;
