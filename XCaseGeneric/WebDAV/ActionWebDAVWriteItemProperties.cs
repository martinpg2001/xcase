namespace XCaseGeneric
{
    ...
    /// <summary>
    /// This action class writes properties for a WebDAV item. The XML file should be of this form:
    /// <operation id="Get WebDAV item proeprties" class="XCaseGeneric.ActionWebDAVWriteItemProperties">
    ...
    /// </summary>
    public class ActionWebDAVWriteItemProperties : ActionAbstract
    {
        #region Logger Setup
        /// <summary>
        ...
        /// <summary>
        /// This method writes properties to a WebDAV item. The XML file should be of this form:
        /// <operation id="Get WebDAV item proeprties" class="XCaseGeneric.ActionWebDAVWriteItemProperties">
        ...
        public override OperationResult Execute(XmlDocument document)
        {
            ...
            {
                string exceptionMessage = "Exception writing WebDAV item properties " + e.Message;
