namespace XCaseGeneric
{
    ...
    /// <summary>
    /// This action class creates a WebDAV folder. The XML file should be of this form:
    /// <operation id="Put a WebDAV item" class="XCaseGeneric.ActionWebDAVCreateFolder">
    ///     <webdav server="" username="" password="" />
    /// </operation>
    /// The ssl attribute is optional.
    /// </summary>
    public class ActionWebDAVCreateFolder : ActionAbstract
    {
        #region Logger Setup
        /// <summary>
        ...
        /// <summary>
        /// This method creates a WebDAV folder. The XML file should be of this form:
        /// <operation id="Put a WebDAV item" class="XCaseGeneric.ActionWebDAVCreateFolder">
        ...
        public override OperationResult Execute(XmlDocument document)
        {
            ...
            try
            {
                OperationResult operationResult = new OperationResult("Success creating folder");
            ...
            {
                string exceptionMessage = "Exception creating folder " + e.Message;
