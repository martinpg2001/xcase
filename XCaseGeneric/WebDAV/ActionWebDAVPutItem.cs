namespace XCaseGeneric
{
    ...
    /// <summary>
    /// This action class puts a WebDAV item. The XML file should be of this form:
    /// <operation id="Put a WebDAV item" class="XCaseGeneric.ActionWebDAVPutItem">
    ///     <webdav server="" username="" password="" />
    /// </operation>
    /// The ssl attribute is optional.
    /// </summary>
    public class ActionWebDAVPutItem : ActionAbstract
    {
        #region Logger Setup
        /// <summary>
        ...
        public override OperationResult Execute(XmlDocument document)
        {
            ...
            try
            {
                OperationResult operationResult = new OperationResult("Success putting WebDAV item");
            ...
            {
                string exceptionMessage = "Exception putting WebDAV item " + e.Message;
