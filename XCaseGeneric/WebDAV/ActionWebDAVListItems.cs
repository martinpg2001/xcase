namespace XCaseGeneric
{
    ...
    /// <operation id="Add an LDAP entry" class="XCaseGeneric.ActionWebDAVListItems">
    ///     <webdav server="" username="" password="" />
    /// </operation>
    /// The ssl attribute is optional.
    /// </summary>
    public class ActionWebDAVListItems : ActionAbstract
    {
        #region Logger Setup
        /// <summary>
        ...
        public override OperationResult Execute(XmlDocument document)
        {
            ...
            try
            {
                OperationResult operationResult = new OperationResult("Success listing WebDAV items");
            ...
            {
                string exceptionMessage = "Exception listing WebDAV items " + e.Message;
