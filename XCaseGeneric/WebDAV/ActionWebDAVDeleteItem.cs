namespace XCaseGeneric
{
    ...
    /// <summary>
    /// This action class deletes a WebDAV item. The XML file should be of this form:
    /// <operation id="Put a WebDAV item" class="XCaseGeneric.ActionWebDAVDeleteItem">
    ///     <webdav server="" username="" password="" />
    /// </operation>
    /// The ssl attribute is optional.
    /// </summary>
    public class ActionWebDAVDeleteItem : ActionAbstract
    {
        #region Logger Setup
        /// <summary>
        ...
        /// <summary>
        /// This method deletes a WebDAV item. The XML file should be of this form:
        /// <operation id="Put a WebDAV item" class="XCaseGeneric.ActionWebDAVDeleteItem">
        ...
        public override OperationResult Execute(XmlDocument document)
        {
            ...
            try
            {
                OperationResult operationResult = new OperationResult("Success deleting WebDAV item");
            ...
            {
                string exceptionMessage = "Exception deleting WebDAV item " + e.Message;
