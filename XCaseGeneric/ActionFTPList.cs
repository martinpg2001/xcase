// ----------------------------------------------------------------------------
// <copyright file="ActionFTPList.cs" company="XCase">
//   Copyright XCase
// </copyright>
// <summary>
...
namespace XCaseGeneric
{
    ...
    /// <summary>
    /// This action class lists files from an FTP server. The XML file should be of this form:
    /// <operation id="List files in FTP directory" class="XCaseGeneric.ActionFTPList">
    ...
    /// </summary>
    public class ActionFTPList : ActionAbstract
    {
        /// <summary>
        /// This method lists files from an FTP server.
        /// </summary>
        ...
        public override OperationResult Execute(XmlDocument document)
        {
            ...
            try
            {
                OperationResult operationResult = new OperationResult("Success listing files");
            ...
            {
                string exceptionMessage = "Exception listing directory " + e.Message;
