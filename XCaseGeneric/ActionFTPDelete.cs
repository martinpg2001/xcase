// ----------------------------------------------------------------------------
// <copyright file="ActionFTPDelete.cs" company="XCase">
//   Copyright XCase
// </copyright>
// <summary>
...
namespace XCaseGeneric
{
    ...
    /// <summary>
    /// This action class deletes a file from an FTP server. The XML file should be of this form:
    /// <operation id="Do Nothing" class="XCaseGeneric.ActionFTPDelete">
    ...
    /// </summary>
    public class ActionFTPDelete : ActionAbstract
    {
        /// <summary>
        ...
        public override OperationResult Execute(XmlDocument document)
        {
            ...
            try
            {
                OperationResult operationResult = new OperationResult("Success deleting file");
            ...
            {
                string exceptionMessage = "Exception deleting file " + e.Message;
