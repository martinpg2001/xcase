namespace XCaseBase
{
    ...
    /// <summary>
    /// This class represents an LDAP datasource.
    /// </summary>
    public class LDAP : Datasource
    {
        #region Logger Setup
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the LDAP class.
        /// </summary>
        /// <param name="argv">The argv parameter.</param>
        public LDAP(Dictionary<string, string> argv)
        {
            this.Host = argv.ContainsKey("host") ? (string)argv["host"] : string.Empty;
            log.Debug("Host is " + this.Host);
            ////this.Host = argv.ContainsKey("server") ? (string)argv["server"] : this.Host;
            ////log.Debug("Host is " + this.Host);
        ...
        {
            return "LDAP:" + this.Host + ":" + this.Port + ":" + this.Path + ":" + this.Username + ":" + this.Password;
        }
    }
}
