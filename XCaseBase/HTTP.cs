namespace XCaseBase
{
    ...
    /// <summary>
    /// This class represents an HTTP datasource.
    /// </summary>
    public class HTTP : Datasource
    {
        #region Logger Setup
        /// <summary>
        ...
        public HTTP(Dictionary<string, string> argv)
        {
        ...
        {
            return "HTTP:" + this.Host + ":" + this.Port + ":" + this.Path + ":" + this.Username + ":" + this.Password;
        }
    }
}
